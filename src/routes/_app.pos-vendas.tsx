        ...
        <div className="space-y-6">
          ...
          <Card className="p-6 bg-primary/5 border-primary/20">
            <h3 className="font-semibold mb-4 flex items-center gap-2">
              <CalendarDays className="h-4 w-4 text-primary" /> Próximas Renovações
            </h3>
            ...
            <Button className="w-full mt-6 font-bold" variant="outline">Ver Todos</Button>
          </Card>

          <Card className="p-6 border-border/40">
            <h3 className="font-semibold mb-6 flex items-center gap-2">
              <Target className="h-4 w-4 text-primary" /> Upsell Pipeline
            </h3>
            <div className="space-y-4">
              <div className="space-y-2">
                <div className="flex justify-between text-xs">
                   <span className="font-medium text-muted-foreground">Proposta Enviada</span>
              ...
              <div className="space-y-2">
                <div className="flex justify-between text-xs">
                   <span className="font-medium text-muted-foreground">Em Negociação</span>
...
function RenewalItem({ name, date, value }: any) {
  return (
    <div className="flex items-center justify-between p-3 rounded-lg bg-background border border-border/40 group hover:border-primary/20 transition-all">
      <div>
