...
const Table = React.forwardRef<HTMLTableElement, React.HTMLAttributes<HTMLTableElement>>(
  ({ className, ...props }, ref) => (
    <div className="relative w-full overflow-auto rounded-lg border bg-card shadow-[var(--shadow-xs)]">
...
>(({ className, ...props }, ref) => (
  <thead
    ref={ref}
    className={cn(
      "sticky top-0 z-10 bg-muted/70 backdrop-blur-md [&_tr]:border-b [&_tr]:border-border/70",
      className,
    )}
    {...props}
  />
