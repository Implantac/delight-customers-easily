...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      ai_copilot_messages: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "ai_copilot_messages_thread_id_fkey"
            columns: ["thread_id"]
            isOneToOne: false
            referencedRelation: "ai_copilot_threads"
            referencedColumns: ["id"]
          },
        ]
      }
      ai_copilot_threads: {
        ...
        Relationships: [
          {
            foreignKeyName: "ai_copilot_threads_organization_id_fkey"
            columns: ["organization_id"]
            isOneToOne: false
            referencedRelation: "org_sales_consolidated_by_branch"
            referencedColumns: ["branch_org_id"]
      ...
      ai_deal_insights: {
        ...
        Relationships: [
          {
            foreignKeyName: "ai_deal_insights_deal_id_fkey"
            columns: ["deal_id"]
            isOneToOne: true
            referencedRelation: "deals"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "ai_deal_insights_organization_id_fkey"
            columns: ["organization_id"]
            isOneToOne: false
            referencedRelation: "org_sales_consolidated_by_branch"
            referencedColumns: ["branch_org_id"]
      ...
      briefing_preferences: {
        ...
        Relationships: [
          {
            foreignKeyName: "briefing_preferences_organization_id_fkey"
            columns: ["organization_id"]
            isOneToOne: false
            referencedRelation: "org_sales_consolidated_by_branch"
            referencedColumns: ["branch_org_id"]
      ...
      commercial_automations: {
        ...
        Relationships: [
          {
            foreignKeyName: "commercial_automations_organization_id_fkey"
            columns: ["organization_id"]
            isOneToOne: false
            referencedRelation: "org_sales_consolidated_by_branch"
            referencedColumns: ["branch_org_id"]
      ...
      whatsapp_inbound_events: {
        ...
        Relationships: [
          {
            foreignKeyName: "whatsapp_inbound_events_channel_id_fkey"
            columns: ["channel_id"]
            isOneToOne: false
            referencedRelation: "whatsapp_channels"
            referencedColumns: ["id"]
    ...
    Enums: {
      ...
      wa_channel_status: "draft" | "active" | "paused" | "error"
      wa_outbox_status: "pending" | "sending" | "sent" | "failed"
      wa_provider: "meta_waba" | "evolution" | "uazapi" | "twilio"
    }
    CompositeTypes: {
      [_ in never]: never
    }
